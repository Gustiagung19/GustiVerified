...
AddEventHandler("playerSpawned", function(spawn)
	TriggerServerEvent('GustiVerified:checkPlayer')
end)

RegisterNetEvent('GustiVerified:clientCheck')
AddEventHandler('GustiVerified:clientCheck', function()
	TriggerServerEvent('GustiVerified:checkPlayer')
end)

RegisterNUICallback('checkCode', function(data, cb)
	TriggerServerEvent('GustiVerified:checkCode', data.code)
    cb('ok')
end)

RegisterNetEvent('GustiVerified:toggleChecker')
AddEventHandler('GustiVerified:toggleChecker', function(toggle)
	ToggleChecker(toggle)
	toggleBlocked(toggle)
end)

RegisterNetEvent('GustiVerified:giveError')
AddEventHandler('GustiVerified:giveError', function(toggle)
	giveError(toggle)
end)
...
RegisterCommand('testFalse', function()
	TriggerServerEvent('GustiVerified:giveFalse')
end)
